...
class TestObtenerDocumentoBteEmitida(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    # El folio se toma del listado del período, igual que hacen los
    # otros tests de BTE con el código de la boleta.
    def test_obtener_documento_bte_emitida(self):
        try:
