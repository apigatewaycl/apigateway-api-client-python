...
class TestListarUsuariosContribuyenteDte(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_listar_usuarios_contribuyente_dte(self):
        try:
            usuarios = self.client.usuarios(self.contribuyente_rut)['data']

            self.assertIsNotNone(usuarios)

            if self.verbose:
                print('test_usuarios(): usuarios', usuarios)
