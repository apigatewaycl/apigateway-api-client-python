...
class TestObtenerDatosContribuyenteDte(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_obtener_datos_contribuyente_dte(self):
        try:
            datos = self.client.datos(self.contribuyente_rut)['data']

            self.assertIsNotNone(datos)

            if self.verbose:
                print('test_datos(): datos', datos)
