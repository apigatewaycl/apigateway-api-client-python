...
class TestDescargarCertificadoSolemnePdfF29(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_certificado_solemne_pdf(self):
        try:
            folio = self._primer_folio()
            pdf = self.client.certificado_solemne_pdf(folio)
            ...
            if self.verbose:
                print('test_certificado_solemne_pdf(): bytes', len(pdf))
