...
class TestObtenerCertificadoAvaluoSimpleData(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_obtener_certificado_avaluo_fiscal_simple_data(self):
        try:
            certificado = self.client.certificado_avaluo_fiscal_simple_data(
                self.comuna,
                self.manzana,
                self.predio,
                self.eac,
            ...
            if self.verbose:
                print(
                    'test_avaluo_fiscal_simple_data(): certificado',
                    certificado,
                )
