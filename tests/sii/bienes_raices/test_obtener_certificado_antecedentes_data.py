...
class TestObtenerCertificadoAntecedentesData(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_obtener_certificado_antecedentes_data(self):
        try:
            certificado = self.client.certificado_antecedentes_data(
                self.comuna,
                self.manzana,
                self.predio,
                self.eac,
            ...
            if self.verbose:
                print('test_antecedentes_data(): certificado', certificado)
