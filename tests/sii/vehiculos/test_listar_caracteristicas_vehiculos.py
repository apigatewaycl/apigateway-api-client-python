...
class TestListarCaracteristicasVehiculos(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_listar_caracteristicas_vehiculos(self):
        try:
            respuesta = self.client.categorias_caracteristicas(self.categoria)
            ...
            if self.verbose:
                print(
                    'test_categorias_caracteristicas(): resultado', resultado
                )
