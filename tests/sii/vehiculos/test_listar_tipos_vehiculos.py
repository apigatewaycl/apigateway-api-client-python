...
class TestListarTiposVehiculos(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_listar_tipos_vehiculos(self):
        try:
            respuesta = self.client.categorias_tipos(self.categoria)
            ...
            if self.verbose:
                print('test_categorias_tipos(): resultado', resultado)
