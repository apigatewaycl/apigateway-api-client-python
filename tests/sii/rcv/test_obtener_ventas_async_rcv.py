...
class TestObtenerVentasAsyncRcv(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # El emisor puede ser una empresa distinta de quien autentica.
        cls.emisor = (
    ...
    def test_obtener_ventas_async_rcv(self):
        try:
            ...
            for _intento in range(self.INTENTOS_ESTADO):
                ...
                if self.verbose:
                    print('test_ventas_async(): estado', estado)
            ...
            detalle = self.client.ventas_async_detalle(
                self.emisor,
                self.periodo,
                id_solicitud,
                self.dte,
            ...
            if self.verbose:
                print('test_ventas_async(): detalle', detalle)
