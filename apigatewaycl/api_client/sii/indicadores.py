...
class Uf(ApiBase):
    ...
    def anual(self, anio):
        ...
        """
        anio = str(anio)
        r = self.client.get(f'/sii/indicadores/uf/anual/{anio}')
        datos = r.json()
    ...
    def mensual(self, periodo):
        ...
        r = self.client.get(f'/sii/indicadores/uf/anual/{anio}/{mes}')
        datos = r.json()
    ...
    def diario(self, dia):
        ...
        r = self.client.get(f'/sii/indicadores/uf/anual/{anio}/{mes}/{dia}')
        datos = r.json()
        key = f'{anio}{mes}{dia}'
